...
public class ArrayListTest01 {
	...
	public static void main(String[] args) {
	 // ArrayList도 기본적인 사용법이 Vector 와 같다.
		...
		System.out.println("DDDDD 값 존재 여부 :" + list2.contains("DDDDD"));
		System.out.println("ZZZZZ 값 존재 여부 :" + list2.contains("ZZZZZ"));
		System.out.println();

		
		// indexOf(비교객체) ==> 리스트에 '비교객체'가 있으면 '비교객체'가 위치한 index 값을 반환하고
		//						'비교객체' 가 없으면 -1 을 반환한다.
		...
		// toArray() ==> 리스트 안에 데이터를 배열로 변환하여 반환한다.
