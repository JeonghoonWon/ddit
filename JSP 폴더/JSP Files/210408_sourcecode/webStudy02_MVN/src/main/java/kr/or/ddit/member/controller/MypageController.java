...
public class MypageController{
	...
	public String mypageGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		return "member/passwordForm";
	}
	
	@RequestMapping(value="/mypage.do", method=RequestMethod.POST)
	public String mypagePost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
